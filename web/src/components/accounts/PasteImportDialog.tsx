...
export default function PasteImportDialog({ open, onClose, onImport }: Props) {
  ...
  const [format, setFormat] = useState<string[]>(['provider', 'email', 'password', 'client_id', 'client_secret', 'refresh_token']);
  ...
  const fieldOptions = ['provider', 'email', 'password', 'client_id', 'client_secret', 'refresh_token'];
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder={'provider----email----password----client_id----client_secret----refresh_token\ngmail----user@gmail.com----pass123----google-client-id----google-secret----token...\nmicrosoft----user@outlook.com----pass456----azure-client-id--------token...'}
            />
          </div>
