...
export function MailContent({ mail, onReply, onForward }: MailContentProps) {
    ...
    <div className="flex h-full flex-col">
      ...
      <div className="space-y-3 border-b border-border p-4">
        ...
        <div className="flex flex-wrap items-center gap-2 text-xs text-muted-foreground">
          {mail.recipients && <span>收件人: {mail.recipients}</span>}
          <span>文件夹: {mail.mailbox}</span>
        </div>
        ...
        <div className="flex flex-wrap gap-2">
          <button
            ...
            className="rounded-lg border border-border px-3 py-1.5 text-xs text-foreground hover:bg-secondary/60"
          >
            回复
          </button>
          <button
