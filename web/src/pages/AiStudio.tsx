...
import type { AiAccount, AiAccountDiagnostics, AiConnectionTestResult, AiMessage, AiProvider, AiThread } from '../types';
  ...
  return (
    <div className="space-y-6">
      <motion.section
        ...
        className="relative overflow-hidden rounded-[32px] border border-zinc-200/70 bg-white/90 p-6 shadow-[0_24px_80px_rgba(15,23,42,0.08)] dark:border-zinc-800 dark:bg-zinc-950/80"
      >
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(6,182,212,0.16),transparent_32%),radial-gradient(circle_at_bottom_right,rgba(244,114,182,0.12),transparent_28%)]" />
        <div className="relative flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-3xl">
            ...
            <h1 className="mt-4 text-3xl font-semibold tracking-tight text-zinc-950 dark:text-zinc-50">把 AI 账号、诊断、模型和对话全部拉到一个台面上</h1>
            <p className="mt-3 max-w-2xl text-sm leading-6 text-zinc-600 dark:text-zinc-400">
              现在不只是能聊，还能看到账号状态、连通性测试、模型缓存、请求传输方式、错误预览、系统提示词和会话沉淀。
            </p>
          </div>
      ...
      <div className="grid gap-6 xl:grid-cols-[340px_260px_minmax(0,1fr)]">
                ...
                >
                  ...
                  <div className="mt-3 flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="opacity-100 rounded-full p-1.5 text-zinc-400 hover:bg-zinc-100 hover:text-zinc-700 md:opacity-0 md:group-hover:opacity-100 dark:hover:bg-zinc-900 dark:hover:text-zinc-200"
                    >
                      <Trash2 className="h-4 w-4" />
                    </button>
                  </div>
